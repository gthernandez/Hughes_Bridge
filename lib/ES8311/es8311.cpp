...
#include <string.h>
#include <Arduino.h>          // hughes_bridge: I2C primitives ported to Arduino Wire so the ES8311
#include <Wire.h>             // shares the SAME bus as the FT6336 touch (SDA16/SCL15) -- no second
#include "es8311.h"           // I2C driver, no bus conflict. Everything else is the vendor driver verbatim.
